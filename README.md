...
| UI | Unified Inbox view, per-Mailbox browse, HTML Message view, compose with optional HTML, local search (`is:unread` / `is:flagged` + text), move a Message to another Mailbox, create a Mailbox, rename a Mailbox, delete a Mailbox |
